...
const CreatePost = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 sm:p-8 shadow-card">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-white hover:file:bg-blue-600 file:transition-colors"
          ...
          <div className="flex justify-end space-x-4 pt-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2.5 bg-primary text-white rounded-lg hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:shadow-md active:scale-98 font-medium"
            >
